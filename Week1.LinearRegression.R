...
summary(a.lm) # view the summary of regression model fit
anova(a.lm)   # Compute analysis of variance (or deviance) 
...
b.lm <- lm(price ~ bedrooms, data = Housing)
...
ab.lm <- lm(price ~ lotsize + bedrooms, data = Housing)
